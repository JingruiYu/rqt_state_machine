...
#ifndef __sensor_egomotion_fusion_hpp__
#define __sensor_egomotion_fusion_hpp__


namespace sensor
{

class egomotion_fusion
{
    public:
        int64_t    timestamp;
...
int egomotion_fusion::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int egomotion_fusion::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int egomotion_fusion::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t egomotion_fusion::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* egomotion_fusion::getTypeName()
{
    return "egomotion_fusion";
}

int egomotion_fusion::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int egomotion_fusion::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int egomotion_fusion::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t egomotion_fusion::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x02ea2933bb208934LL;
